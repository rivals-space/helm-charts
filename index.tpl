  ...
  <body>
    ...
    <section class="markdown-body">
      ...
      <pre class="snippet" lang="no-highlight" style="padding: 0">
        <button class="btn" data-clipboard-snippet="helm repo add rivals-space https://charts.rivals.space/">
          <img class="clippy" src="_images/clippy.svg" alt="Copy to clipboard" width="13">
        </button>
        <code>helm repo add rivals-space https://charts.rivals.space/</code>
      </pre>

      <h2>How they are built</h2>
      <p>
        <ul>
          <li><a href="https://github.com/rivals-space/helm-charts">Github repos</a></li>
        </ul>
      </p>
            ...
            <a href="{{ (index (index $chartEntry 0).Urls 0) }}" title="{{ (index (index $chartEntry 0).Urls 0) }}">
              ...
              <div class="body">
                <p class="info">
                  ...
                  <a href="https://github.com/rivals-space/helm-charts/tree/main/charts/{{ $key }}">
                    <img src="_images/gh-logo.png" alt="github link" style="height: 16px; width: 16px; vertical-align: middle;" />
                  </a>
                </p>
                <p class="description">
